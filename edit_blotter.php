...
(function() {
    ...
    const editTabPanes = document.querySelectorAll('#editRecordModal .tab-pane');
    ...
    function loadEditRecordData(data) {
        ...
        document.querySelector('#editRecordModal .modal-body').innerHTML = document.getElementById('editRecordForm').outerHTML;
