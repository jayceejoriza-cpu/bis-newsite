...
try {
    ...
    $upload_base_dir = 'uploads/barangay';
    ...
    if (isset($_FILES['municipal_logo']) && $_FILES['municipal_logo']['error'] === UPLOAD_ERR_OK) {
        ...
        $municipal_logo_path = $logos_dir . '/' . $filename;
        
        if (!move_uploaded_file($file['tmp_name'], $municipal_logo_path)) {
    ...
    if (isset($_FILES['barangay_logo']) && $_FILES['barangay_logo']['error'] === UPLOAD_ERR_OK) {
        ...
        $barangay_logo_path = $logos_dir . '/' . $filename;
        
        if (!move_uploaded_file($file['tmp_name'], $barangay_logo_path)) {
    ...
    if (isset($_FILES['dashboard_image']) && $_FILES['dashboard_image']['error'] === UPLOAD_ERR_OK) {
        ...
        $dashboard_image_path = $dashboard_dir . '/' . $filename;
        
        if (!move_uploaded_file($file['tmp_name'], $dashboard_image_path)) {
