...
try {
    ...
    if (!$certificateData) {
        // Certificate not found - log and show error
        error_log("Certificate ID $certificateId not found in database");
        
        // Check if any certificates exist
        $countStmt = $pdo->query("SELECT COUNT(*) as total FROM certificates");
        $total = $countStmt->fetch()['total'];
        error_log("Total certificates in database: $total");
        
        // Redirect with error message
        $_SESSION['error'] = "Certificate not found (ID: $certificateId)";
        header('Location: certificates.php');
        exit;
    }
    
} catch (PDOException $e) {
    error_log("Database error fetching certificate: " . $e->getMessage());
...
<head>
    ...
    <link rel="stylesheet" href="css/create-certificate.css">
</head>
<body>
    <!-- Sidebar -->
        ...
        <div class="create-certificate-wrapper">
            ...
            <div class="certificate-top-bar">
                <div class="top-bar-left">
                    ...
                    <h2 class="page-title-inline">Edit Certificate</h2>
    ...
    <script src="js/create-certificate.js"></script>
</body>
</html>
