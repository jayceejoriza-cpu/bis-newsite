...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2026 at 02:54 AM
...
(332, 'admin', 'Logout', 'User logged out successfully', '2026-04-20 03:09:22'),
(333, 'admin', 'Login', 'User logged in successfully', '2026-04-20 03:10:23'),
(334, 'admin', 'Update Profile Image', 'User updated their profile image', '2026-04-20 15:51:55');
...
CREATE TABLE `barangay_officials` (
  ...
  `hierarchy_level` int(11) DEFAULT 1 COMMENT 'Hierarchy level for org chart (1=top, 2=middle, 3=bottom)',
...
(52, 11, 13, 'Maria Mendoza Santos', NULL, '', NULL, '2026-04-20 13:13:54'),
(53, 11, 13, 'Maria Mendoza Santos', NULL, '', 'VICTIM', '2026-04-20 13:13:54'),
(56, 12, 13, 'Maria Mendoza Santos', '+639735231653', '', NULL, '2026-04-20 16:47:20'),
(57, 12, 13, 'Maria Mendoza Santos', '+639735231655', '', 'VICTIM', '2026-04-20 16:47:20');
...
INSERT INTO `blotter_history` (`id`, `blotter_id`, `action_type`, `old_value`, `new_value`, `remarks`, `changed_by`, `created_at`) VALUES
(1, 12, 'Rescheduled', 'Status: Scheduled for Mediation | Sched: April 20, 2026 08:59 PM', 'Status: Scheduled for Mediation | Sched: April 20, 2026 08:02 PM', 'No remarks provided.', 1, NULL),
(2, 11, 'Rescheduled', 'Status: Scheduled for Mediation | Sched: April 20, 2026 08:29 PM', 'Status: Scheduled for Mediation | Sched: April 20, 2026 09:13 PM', 'AWD AWD', 1, '2026-04-20 21:13:54'),
(3, 12, 'Rescheduled', 'Status: Scheduled for Mediation | Sched: April 20, 2026 08:02 PM', 'Status: Scheduled for Mediation | Sched: April 20, 2026 11:52 PM', 'FINE', 1, '2026-04-20 23:52:44'),
(4, 12, 'Rescheduled', 'Status: Scheduled for Mediation | Sched: April 20, 2026 11:52 PM', 'Status: Scheduled for Mediation | Sched: April 21, 2026 12:47 AM', '3rd', 1, '2026-04-21 00:47:20'),
(5, 11, 'Status & Schedule Updated', 'Status: Scheduled for Mediation | Sched: April 20, 2026 09:13 PM', 'Status: Endorsed to Police', 'No remarks provided.', 1, NULL),
(6, 11, 'Status Updated', 'Status: Endorsed to Police', 'Status: Pending', 'No remarks provided.', 1, NULL);
...
CREATE TABLE `blotter_records` (
  ...
  `status` enum('Pending','Under Investigation','Resolved','Dismissed','Scheduled for Mediation','Settled','Endorsed to Police') DEFAULT 'Pending',
  ...
  `case_outcome` varchar(50) DEFAULT NULL COMMENT 'Settled|Scheduled for Mediation|Referred to Police/Court (CFA)|Dismissed',
  `incident_proof` varchar(255) DEFAULT NULL,
  `settlement_proof` varchar(255) DEFAULT NULL,
...
(11, 'BR-2026-000003', 'Verbal Dispute', 'WAWDAWDWDA', '2026-04-20 11:10:00', 'BARANGAY WAWANDUE', '2026-04-20 11:11:17', NULL, 'Pending', NULL, NULL, NULL, 'AWD AWD', NULL, 'assets/uploads/blotter/incident_11_1776654677_0.jpg,assets/uploads/blotter/incident_11_1776654677_1.jpg,assets/uploads/blotter/incident_11_1776654677_2.jpg', NULL, NULL, NULL, NULL, NULL, '2026-04-20 03:11:17', '2026-04-20 17:09:58', NULL, NULL),
(12, 'BR-2026-000004', 'Bugbugan', 'wade', '2026-04-20 20:37:00', 'wad', '2026-04-20 20:38:00', NULL, 'Scheduled for Mediation', '2026-04-21 00:47:00', NULL, NULL, '3rd', NULL, 'assets/uploads/blotter/incident_12_1776688680_0.jpg', NULL, NULL, NULL, NULL, NULL, '2026-04-20 12:38:00', '2026-04-20 16:47:20', NULL, NULL);
...
(36, 11, 14, 'Juan Miguel Torres Silva Jr.', NULL, '', NULL, '2026-04-20 13:13:54'),
(38, 12, 14, 'Juan Miguel Torres Silva Jr.', '+63987654321', '', NULL, '2026-04-20 16:47:20');
...
CREATE TABLE `events` (
  ...
  `event_type` enum('Barangay','Resident') NOT NULL DEFAULT 'Barangay',
  `status` varchar(50) DEFAULT NULL,
  `resident_id` int(11) DEFAULT NULL COMMENT 'Link to residents.id if event_type is Resident',
  `created_by` int(11) NOT NULL COMMENT 'Link to users.id',
...
CREATE TABLE `households` (
  ...
  `landlord_resident_id` int(11) DEFAULT NULL,
  ...
  `updated_by` int(11) DEFAULT NULL,
  `property_status` varchar(20) DEFAULT 'Owned' COMMENT 'Owned or Rent',
  `renter_resident_id` int(11) DEFAULT NULL COMMENT 'Resident ID of renter'
...
CREATE TABLE `residents` (
  ...
  `age` int(11) DEFAULT NULL COMMENT 'Calculated from date_of_birth',
  ...
  `father_resident_id` int(11) DEFAULT NULL,
  `mother_name` varchar(255) DEFAULT NULL,
  `mother_resident_id` int(11) DEFAULT NULL,
  ...
  `pwd_type` varchar(255) DEFAULT NULL,
  `pwd_id_number` varchar(100) DEFAULT NULL,
  ...
  `is_house_occupied` varchar(10) DEFAULT 'Yes',
  ...
  `renter_resident_id` int(11) DEFAULT NULL
...
(226, 'W-00226', 'assets/uploads/residents/resident_1775311366_69d11a0674f09.png', 'Juan', NULL, 'Dela Cruz', NULL, 'Male', '2000-01-01', 26, 'San Marcelino', 'Christian', 'Non-IPS', '917 823 6154', 'Purok 3, Taas Tulay', '3', 'Taas Tulay', 'Single', NULL, NULL, NULL, NULL, NULL, 0, 'College Graduate', 'Employed', 'Student', 'No', NULL, 'No', NULL, 'No', NULL, NULL, 'No', NULL, 'None', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Yes', NULL, NULL, NULL, 'Alive', '2026-04-04 22:02:46', NULL, '2026-03-20 16:10:16', '2026-04-04 14:02:46', NULL, NULL, NULL, NULL, NULL),
...
(235, 'W-00050', 'assets/uploads/residents/resident_1775486923_69d3c7cbf147d.png', 'Alejandro', 'Gonzales', 'Bautista', 'Jr.', 'Male', '1980-01-21', 46, 'San Felipe', 'Christian', 'Non-IPS', '973 523 1650', 'Purok 3, Streetv 131', '3', 'Streetv 131', 'Single', NULL, 'Alistair Santos', NULL, 'Nadia Silva', NULL, 0, 'Elementary Level', 'Unemployed', 'OFW', 'No', NULL, 'Yes', NULL, 'No', NULL, NULL, 'No', '2312-3231-3121', 'Member', 'Direct Contributor', 'Adult (20-59 years)', NULL, NULL, NULL, NULL, NULL, 'Yes', NULL, NULL, NULL, 'Alive', '2026-04-09 23:35:02', 1, '2026-04-12 08:38:45', '2026-04-12 08:38:45', NULL, NULL, NULL, NULL, NULL),
...
(1, 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'System Administrator', 'assets/uploads/avatars/avatar_1_1776700315.jpg', 'Admin', 'Active', '2026-02-12 15:55:42', '2026-04-20 15:51:55'),
...
--
ALTER TABLE `blotter_history`
  ADD CONSTRAINT `blotter_history_ibfk_1` FOREIGN KEY (`blotter_id`) REFERENCES `blotter_records` (`id`) ON DELETE CASCADE;
