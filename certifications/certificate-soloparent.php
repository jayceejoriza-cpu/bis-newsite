...
<link rel="icon" type="image/png" href="../uploads/favicon.png"> 
    ...
    <title>Certificate of Solo Parent - <?= htmlspecialchars($brgy) ?></title>
        ...
        <div class="dashboard-content">
            <div class="card">
                <div class="card-header">
                    <div class="fw-bold">Certificate of Solo Parent</div>
                </div>
                ...
                <div class="card-body" id="printThis">
                    <div class="cert-page">
                        ...
                        <!-- =====================
                             Title
                        ===================== -->
                        <h2 class="cert-title">CERTIFICATION OF SOLO PARENT</h2>
                            ...
                            <div class="cert-body">
                                ...
                                <div class="cert-body-content">
                                    ...
                                    <p class="text-indent">
                                        ...
                                        of legal age,
                                        Filipino citizen, single with dependent and a bonifide resident of 
