...
$day   = date('d',  $certDateObj->getTimestamp());
...
<head>
    ...
    <title>Business Clearance/Business Permit for BUSINESS - <?= htmlspecialchars($brgy) ?></title>
...
<body>
        ...
        <div class="dashboard-content">
            <div class="card">
                <div class="card-header">
                    <div class="fw-bold">Business Clearance/Business Permit for BUSINESS</div>
                </div>
                ...
                <div class="card-body" id="printThis">
                    <div class="cert-page">
                        ...
                        <!-- =====================
                             Title
                        ===================== -->
                        <h2 class="cert-title">OFFICE OF THE PUNONG BARANGAY</h2>
                        ...
                        <div class="cert-content-area">
                            ...
                            <div class="cert-body">
                             ...
                             Date
                                ===================== -->
                                        <span><?= strtoupper($monthName) ?></span>
                                        <span><?= $day ?></span>,
                                        <span><?= $yearNum ?></span>

                                    <!-- Header -->
                                    <p style="margin-top: 10px; font-size:14px;">
                                        <strong>MS. MARIA ELISA B. AMADOR</strong><br>
                                        <span>OIC-Business Processing and Licensing Officer</span><br>
                                        <span><?= ucwords($town) ?></span>, <span><?= ucwords($province) ?></span>
                                    </p>
                                    ...
                                    <p>
                                        Respectfully endorsing to your good office an applicant for BUSINESS CLEARANCE/BUSINESS PERMIT for
                                        BUSINESS, who has complied with requirements prescribed by the office, which will operate at
    ...
    <script>
        ...
        function saveAndPrint() {
            ...
            formData.append('certificate_type', 'Business Permit');
            formData.append('purpose', '<?php echo !empty($nature) ? htmlspecialchars($nature) : "Business Permit"; ?>');
