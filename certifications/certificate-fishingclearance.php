...
<head>
    ...
    <title>Barangay Fishing Clearance - <?= htmlspecialchars($brgy) ?></title>
    ...
    <style>
        ...
        .cert-header {
            ...
            border-bottom: 3px double #7241ce;
            padding-bottom: 10px;
            margin-bottom: 12px;
            margin-top: 70px;
        }
...
<body>
        ...
        <div class="dashboard-content">
            <div class="card">
                <div class="card-header">
                    <div class="fw-bold">Barangay Fishing Clearance</div>
                </div>
                ...
                <div class="card-body" id="printThis">
                    <div class="cert-page">
                        ...
                        <!-- =====================
                             Title
                        ===================== -->
                        <h2 class="cert-title">BARANGAY FISHING CLEARANCE</h2>
                            ...
                            <div class="cert-body">
                                ...
                                <div class="cert-body-content">
                                    ...
                                    <p class="text-indent">
                                        ...
                                        of legal age, 
                                        Filipino citizen, with residence and with postal address at    
    ...
    <script>
        ...
        function saveAndPrint() {
            ...
            formData.append('certificate_type', 'Barangay Fishing Clearance');
            formData.append('purpose', '<?php echo !empty($purpose) ? htmlspecialchars($purpose) : "Fishing Clearance"; ?>');
