...
$work_type   = isset($_GET['work_type'])   ? $_GET['work_type']           : 'N/A';
$work_year   = isset($_GET['work_year'])   ? $_GET['work_year']           : date('Y');
$purpose     = isset($_GET['purpose'])     ? $_GET['purpose']             : 'MEDICAL';
$income    = isset($_GET['income'])    ? number_format((float)$_GET['income'], 2) : '0.00';
if ($resident_id <= 0) {
...
<link rel="icon" type="image/png" href="../uploads/favicon.png"> 
    ...
    <title>Certificate of Low-Income - <?= htmlspecialchars($brgy) ?></title>
...
<body>
        ...
        <div class="dashboard-content">
            <div class="card">
                <div class="card-header">
                    <div class="fw-bold">Certificate of Low-Income</div>
                </div>
                ...
                <div class="card-body" id="printThis">
                    <div class="cert-page">
                        ...
                        <!-- =====================
                             Title
                        ===================== -->
                        <h2 class="cert-title">CERTIFICATION OF LOW-INCOME</h2>
                            ...
                            <div class="cert-body">
                                ...
                                <div class="cert-body-content">
                                    ...
                                    <p class="text-indent">
                                        ...
                                        of legal age,
                                        Filipino citizen, <span><?= ucwords($resident['civil_status']) ?></span> and a resident of and
                                    ...
                                    <p class="text-indent">
                                     ...
                                     <!-- Paragraph 3: Purpose -->
                                    <p class="text-indent">
                                       This certification is issued upon the request of above-mentioned name for 
                                       <strong><?= strtoupper(htmlspecialchars($purpose)) ?> ASSISTANCE</strong>. 
                                    </p>
                  ...
                  <!-- Signatures -->
                                    <div class="cert-signatures">
                                        ...
                                        <div class="sig-right">
                                            <div class="sig-attest-label">ATTESTED BY:</div>
                                            <?php if (!empty($brgy_admin)): ?>
                                            <div class="sig-admin-name"><?= strtoupper($brgy_admin['name']) ?></div>
                                            <div class="sig-admin-title">Barangay Admin</div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function saveAndPrint() {
            ...
            formData.append('purpose', '<?php echo !empty($purpose) ? htmlspecialchars($purpose) : "Low Income Verification"; ?>');
