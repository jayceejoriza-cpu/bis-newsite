...
function searchResidentsForPicker(term) {
    ...
    fetch('search_residents_official.php?search=' + encodeURIComponent(term))
        .then(r => r.json())
        .then(data => {
...
async function submitCreateOfficial() {
    ...
    try {
        ...
        const response = await fetch('save_official.php', { method: 'POST', body: formData });
...
function viewOfficialDetails(officialId) {
    ...
    fetch('get_official_details.php?id=' + encodeURIComponent(officialId))
        .then(r => r.json())
        .then(data => {
...
function editOfficial(officialId) {
    ...
    // Fetch official data
    fetch('get_official_for_edit.php?id=' + encodeURIComponent(officialId))
        .then(r => r.json())
        .then(data => {
...
async function submitEditOfficial() {
    ...
    try {
        ...
        const response = await fetch('update_official.php', { method: 'POST', body: formData });
        const result   = await response.json();
